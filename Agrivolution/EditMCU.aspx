...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p>
        ...
        <asp:SqlDataSource ID="MCUAttributeSource" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" SelectCommand="SELECT [Facility], [Room], [GroupName], [MCUId], [PumpStatus] FROM [MCU] WHERE ([UserName] = @UserName AND MCUId=@MCUId)">
            <SelectParameters>
                <asp:ControlParameter ControlID="UseName" Name="UserName" Type="String" DefaultValue="Anonymous" />
            </SelectParameters>
            <SelectParameters>
                <asp:QueryStringParameter Name="MCUId" QueryStringField="MCUId" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
    </p>
    <p>
        <asp:Label ID="roomLable" runat="server" Text="Room Name:  "></asp:Label>
        <asp:TextBox ID="roomName" runat="server"></asp:TextBox>
    </p>
    <p>
        <asp:Label ID="facilityLable" runat="server" Text="Facility Name:"></asp:Label>
